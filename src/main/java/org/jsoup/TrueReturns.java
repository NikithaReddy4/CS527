...
public class TrueReturns extends VoidVisitorAdapter<String>
{
    ...
    public TrueReturns(CompilationUnit originalCu) {
                    ...
                    if (expr != null && expr.isBooleanLiteralExpr()) {
                        ...
                        if (!booleanLiteralExpr.getValue()) {
                            ...
                            if (mutantReturnStmt != null) {
                                mutantReturnStmt.setExpression(new BooleanLiteralExpr(true));
                                mutants.add(mutant);
